  ...
  return (
    <div 
      className={cn(
        ...
        isActive 
          ? "bg-white shadow-elegant border-brand-200" 
...
const HowItWorks = () => {
  ...
  return (
    <section className="py-20 bg-white relative" id="how-it-works" ref={sectionRef}>
      ...
      <div className="absolute -top-20 right-0 w-72 h-72 bg-brand-50 rounded-full opacity-60 blur-3xl -z-10"></div>
      ...
      <div className="section-container">
        <div className="text-center mb-16 opacity-0 fade-in-stagger">
          <h2 className="section-title mb-4" style={{ fontFamily: 'Brockmann, Inter, sans-serif' }}>How Atlas Integrates Into Your Life</h2>
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-dark-900/70 to-transparent">
                  <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                    <span className="text-brand-400 font-medium mb-2 block">{step.number}</span>
