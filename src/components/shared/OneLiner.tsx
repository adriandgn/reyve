      ...
      <div className="container px-4 sm:px-6 lg:px-8 mx-auto">
        <div className="max-w-5xl pl-4 sm:pl-8">
          <h2 className="text-4xl md:text-6xl lg:text-6xl xl:text-7xl font-display md:leading-tight mb-8">
            ...
            <span style={{color: '#2c4c71'}}> Re:YVE is a product life-extension platform that enables </span>clothing-to-clothing production at scale<span style={{color: '#2c4c71'}}> to turn unsold inventory into new revenue.</span>
            </span>
          </h2>
        </div>
      </div>
