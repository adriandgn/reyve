...
const ImageShowcaseSection = () => {
  ...
  <h2 className="font-brockmann text-4xl sm:text-5xl font-extrabold tracking-tight text-circularity-navy mb-4 leading-tight">
    Our process of <span className="bg-[#30f534]/80 px-2 rounded">Re:Creation</span>
  </h2>
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-xl min-h-[420px] flex items-center justify-center">
            ...
            <div className="absolute top-6 left-6 flex flex-col gap-4">
              <div className="bg-white/95 backdrop-blur-md rounded-xl px-5 py-3 shadow-lg border border-circularity-green/40 animate-fade-in">
                ...
                <div className="text-xs text-gray-600">Data Consolidation</div>
              </div>
            </div>
  ...
  <div className="group feature-item transition-all duration-300 cursor-pointer bg-white rounded-2xl shadow-lg border border-circularity-green/30 hover:border-circularity-green hover:shadow-2xl hover:scale-[1.025] hover:bg-[#30f534]/5 flex items-center px-6 py-5 gap-5 relative">
    ...
    <div>
      <h3 className="font-brockmann text-xl font-bold text-circularity-navy mb-1">Data Consolidation</h3>
      <div className="font-montserrat text-[#30f534] font-semibold mb-0.5">Fashion Brands</div>
  ...
  <div className="group feature-item transition-all duration-300 cursor-pointer bg-white rounded-2xl shadow-lg border border-circularity-green/30 hover:border-circularity-green hover:shadow-2xl hover:scale-[1.025] hover:bg-[#30f534]/5 flex items-center px-6 py-5 gap-5 relative">
    ...
    <div>
      <h3 className="font-brockmann text-xl font-bold text-circularity-navy mb-1">Crowd-source creativity</h3>
      <div className="font-montserrat text-[#30f534] font-semibold mb-0.5">Redesigners</div>
      <p className="font-montserrat text-gray-700"><span>Accredited redesigners submit digital <b>upcycle concepts</b> aligned with each data pack -to outperform originals</span></p>
    </div>
  </div>
  ...
  <div className="group feature-item transition-all duration-300 cursor-pointer bg-white rounded-2xl shadow-lg border border-circularity-green/30 hover:border-circularity-green hover:shadow-2xl hover:scale-[1.025] hover:bg-[#30f534]/5 flex items-center px-6 py-5 gap-5 relative">
    ...
    <div>
      <h3 className="font-brockmann text-xl font-bold text-circularity-navy mb-1">Sample & Approval</h3>
      <div className="font-montserrat text-[#30f534] font-semibold mb-0.5">Makers</div>
      <p className="font-montserrat text-gray-700"><span>Brand approved redesigns become <b>repeatable maker recipes</b> with specs, time, and quality steps</span></p>
    </div>
  </div>
  ...
  <div className="group feature-item transition-all duration-300 cursor-pointer bg-white rounded-2xl shadow-lg border border-circularity-green/30 hover:border-circularity-green hover:shadow-2xl hover:scale-[1.025] hover:bg-[#30f534]/5 flex items-center px-6 py-5 gap-5 relative">
    ...
    <div>
      ...
      <div className="font-montserrat text-[#30f534] font-semibold mb-0.5">Consumers</div>
      <p className="font-montserrat text-gray-700"><span>Final redesigns are listed as <b>made-to-order</b> via established sales channels, avoiding new inventory</span></p>
    </div>
  </div>
</div>
        </div>
